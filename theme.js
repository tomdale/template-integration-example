...
TemplateIntegrationExample.Theme = SC.AceTheme.create({
  name: 'template-integration-example'
});

// SproutCore needs to know that your app's theme exists
SC.Theme.addTheme(TemplateIntegrationExample.Theme);

// Setting it as the default theme makes every pane SproutCore
// creates default to this theme unless otherwise specified.
SC.defaultTheme = 'template-integration-example';
